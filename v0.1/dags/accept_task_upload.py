...
def append_file_names_to_list(**context):
    ...
    local_directory = '/opt/airflow/Desktop/upload_temp'
    ...
    for file_name in file_list:
        ...
        scp_client.put(f'{local_directory}/{file_name}',f'{remote_directory}/{file_name}')
...
with DAG('accept_task_upload', default_args=default_args, schedule_interval=None) as dag:
